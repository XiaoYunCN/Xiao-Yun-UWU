...
Dino.Text = "这个图形用户界面不是最好的免费利用。主要是针对付费漏洞，比如Visenya，Synapse等。如果你使用的是免费的lua 执行，那么如果有些东西不能正常工作，请不要惊讶"
...
TeamOPorCL.Text = "打开/关闭团队GUI上的停留"
